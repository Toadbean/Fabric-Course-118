...
public class ModTags {
    public static class Blocks {
        ...
        public static Tag.Identified<Block> createTag(String name) {
    ...
    public static class Items {
        ...
        public static final Tag.Identified<Item> ORICHALCUM_INGOTS =
                createCommonTag("orichalcum_ingots");

        public static final Tag.Identified<Item> ORICHALCUM_NUGGETS =
